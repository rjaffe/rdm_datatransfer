A notebook and supporting files to help profile the contents of a local filesystem in preparation for transferring the data. The tools will be primarily *nix and bash shell commands and scripts.
